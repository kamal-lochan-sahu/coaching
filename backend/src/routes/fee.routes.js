...
import { getFees, collectFee, getPendingFees, getStudentFees, waiveFee, getFeeReport, generateFeeForBatch } from "../controllers/fee.controller.js";
...
router.put("/:id/waive",         adminAndAbove, waiveFee);
